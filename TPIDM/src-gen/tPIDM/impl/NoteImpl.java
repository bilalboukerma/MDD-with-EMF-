 ...
 * </p>
 * <ul>
 *   <li>{@link tPIDM.impl.NoteImpl#getDate <em>Date</em>}</li>
 *   <li>{@link tPIDM.impl.NoteImpl#getValeur <em>Valeur</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NoteImpl extends MinimalEObjectImpl.Container implements Note {
	...
	protected EClass eStaticClass() {
		return TPIDMPackage.Literals.NOTE;
	}
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TPIDMPackage.NOTE__DATE, oldDate, date));
	}
	...
	public void setValeur(int newValeur) {
		...
		valeur = newValeur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TPIDMPackage.NOTE__VALEUR, oldValeur, valeur));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TPIDMPackage.NOTE__DATE:
			return getDate();
		case TPIDMPackage.NOTE__VALEUR:
			return getValeur();
		}
